namespace projeto_medtime
{
    partial class pagina_dois_cadastro
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(pagina_dois_cadastro));
            ...
            pictureBox_outros = new PictureBox();
            checkBox_masculino = new CheckBox();
            checkBox_feminino = new CheckBox();
            checkBox_outros = new CheckBox();
            pictureBox_masculino = new PictureBox();
            pictureBox_feminino = new PictureBox();
            ((System.ComponentModel.ISupportInitialize)pictureBox_outros).BeginInit();
            ((System.ComponentModel.ISupportInitialize)pictureBox_masculino).BeginInit();
            ((System.ComponentModel.ISupportInitialize)pictureBox_feminino).BeginInit();
            SuspendLayout();
            // 
            // lbl_nome_cadastro
            // 
            ...
            lbl_cpf_cadastro.Location = new Point(493, 187);
            ...
            msk_txtB_CPF.Location = new Point(493, 224);
            ...
            // pictureBox_outros
            // 
            pictureBox_outros.Image = (Image)resources.GetObject("pictureBox_outros.Image");
            pictureBox_outros.Location = new Point(48, 94);
            pictureBox_outros.Name = "pictureBox_outros";
            pictureBox_outros.Size = new Size(400, 400);
            pictureBox_outros.SizeMode = PictureBoxSizeMode.StretchImage;
            pictureBox_outros.TabIndex = 17;
            pictureBox_outros.TabStop = false;
            // 
            // checkBox_masculino
            // 
            checkBox_masculino.AutoSize = true;
            checkBox_masculino.Font = new Font("Franklin Gothic Heavy", 12F, FontStyle.Regular, GraphicsUnit.Point, 0);
            checkBox_masculino.ForeColor = SystemColors.Window;
            checkBox_masculino.Location = new Point(497, 157);
            checkBox_masculino.Name = "checkBox_masculino";
            checkBox_masculino.Size = new Size(118, 25);
            checkBox_masculino.TabIndex = 18;
            checkBox_masculino.Text = "MASCULINO";
            checkBox_masculino.UseVisualStyleBackColor = true;
            checkBox_masculino.CheckedChanged += checkBox_masculino_CheckedChanged;
            // 
            // checkBox_feminino
            // 
            checkBox_feminino.AutoSize = true;
            checkBox_feminino.Font = new Font("Franklin Gothic Heavy", 12F, FontStyle.Regular, GraphicsUnit.Point, 0);
            checkBox_feminino.ForeColor = SystemColors.Window;
            checkBox_feminino.Location = new Point(621, 157);
            checkBox_feminino.Name = "checkBox_feminino";
            checkBox_feminino.Size = new Size(103, 25);
            checkBox_feminino.TabIndex = 19;
            checkBox_feminino.Text = "FEMININO";
            checkBox_feminino.UseVisualStyleBackColor = true;
            checkBox_feminino.CheckedChanged += checkBox2_CheckedChanged;
            // 
            // checkBox_outros
            // 
            checkBox_outros.AutoSize = true;
            checkBox_outros.Font = new Font("Franklin Gothic Heavy", 12F, FontStyle.Regular, GraphicsUnit.Point, 0);
            checkBox_outros.ForeColor = SystemColors.Window;
            checkBox_outros.Location = new Point(737, 157);
            checkBox_outros.Name = "checkBox_outros";
            checkBox_outros.Size = new Size(90, 25);
            checkBox_outros.TabIndex = 20;
            checkBox_outros.Text = "OUTROS";
            checkBox_outros.UseVisualStyleBackColor = true;
            checkBox_outros.CheckedChanged += checkBox_outros_CheckedChanged;
            // 
            // pictureBox_masculino
            // 
            pictureBox_masculino.Image = (Image)resources.GetObject("pictureBox_masculino.Image");
            pictureBox_masculino.Location = new Point(48, 94);
            pictureBox_masculino.Name = "pictureBox_masculino";
            pictureBox_masculino.Size = new Size(400, 400);
            pictureBox_masculino.SizeMode = PictureBoxSizeMode.StretchImage;
            pictureBox_masculino.TabIndex = 21;
            pictureBox_masculino.TabStop = false;
            // 
            // pictureBox_feminino
            // 
            pictureBox_feminino.Image = (Image)resources.GetObject("pictureBox_feminino.Image");
            pictureBox_feminino.Location = new Point(48, 94);
            pictureBox_feminino.Name = "pictureBox_feminino";
            pictureBox_feminino.Size = new Size(400, 400);
            pictureBox_feminino.SizeMode = PictureBoxSizeMode.StretchImage;
            pictureBox_feminino.TabIndex = 22;
            pictureBox_feminino.TabStop = false;
            pictureBox_feminino.Click += pictureBox1_Click;
            // 
            ...
            Controls.Add(pictureBox_feminino);
            Controls.Add(pictureBox_masculino);
            Controls.Add(checkBox_outros);
            Controls.Add(checkBox_feminino);
            Controls.Add(checkBox_masculino);
            Controls.Add(pictureBox_outros);
        ...
        private PictureBox pictureBox_outros;
        private CheckBox checkBox_masculino;
        private CheckBox checkBox_feminino;
        private CheckBox checkBox_outros;
        private PictureBox pictureBox_masculino;
        private PictureBox pictureBox_feminino;
    }
}